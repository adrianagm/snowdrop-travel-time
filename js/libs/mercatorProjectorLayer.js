function loadMercatorProjectorLayer() {
    /*
     Document   	: wms.js
    ...
    MercatorProjectionLayer = {};
    MercatorProjectionLayer.loadWMS = function loadWMS(layer, requestParams) {
        var isPng = true;
        var minZoomLevel = 2;
        var maxZoomLevel = 28;
        ...
        var overlayOptions = {
            getTileUrl: function(coord, zoom) {
                ...
                var urlResult = layer.url;
                urlResult += "?REQUEST=GetMap";
                for (var p in requestParams) {
                    urlResult += "&" + p + "=" + requestParams[p];
                }
            ...
            tileSize: new google.maps.Size(requestParams.height, requestParams.width),
    ...
    window.MercatorProjectionLayer = MercatorProjectionLayer;
}